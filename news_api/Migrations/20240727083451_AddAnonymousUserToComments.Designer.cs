...
namespace news_api.Migrations
{
    ...
    [Migration("20240727083451_AddAnonymousUserToComments")]
    partial class AddAnonymousUserToComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("news_api.Models.Comment", b =>
                {
                    ...
                    b.Property<string>("AnonymousUser")
                        .IsRequired()
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("news_api.Models.Comment", b =>
                {
                    b.HasOne("news_api.model.News", "News")
                        .WithMany("Comments")
